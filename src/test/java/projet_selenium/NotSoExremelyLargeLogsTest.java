...
public class NotSoExremelyLargeLogsTest extends AbstractTest {
	@Before
	public void setUp(){
		System.setProperty("log4j.configurationFile","log4j2.xml");
	}
	private static final Logger logger = LoggerFactory.getLogger(NotSoExremelyLargeLogsTest.class);
	@Test
